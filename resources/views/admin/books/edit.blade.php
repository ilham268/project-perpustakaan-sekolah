    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <form method="POST" action="{{ route('books.update', $book->id) }}" enctype="multipart/form-data" class="space-y-5">
            ...
            <div>
                ...
                <div id="preview-container" class="{{ $book->foto ? '' : 'hidden' }} mb-3">
                    <div class="flex items-start gap-4">
                        <div class="relative w-40 h-40 shrink-0">
                            <img id="preview-image" src="{{ $book->foto ? Storage::url($book->foto) : '' }}" alt="Preview" class="w-full h-full object-cover rounded-lg border border-gray-300">
                        ...
                        <div class="flex flex-col gap-1.5 pt-1">
                            <span id="foto-status" class="inline-flex items-center gap-1.5 text-xs font-medium text-green-700 bg-green-50 border border-green-200 px-2.5 py-1 rounded-full">
                                <i class="fas fa-check-circle"></i>
                                {{ $book->foto ? 'Foto tersimpan' : 'Foto berhasil diunggah' }}
                            </span>
                ...
                <div id="upload-area" class="{{ $book->foto ? 'hidden' : '' }} border-2 border-dashed border-gray-300 rounded-lg p-6 text-center cursor-pointer transition-colors hover:border-cyan-400">
    ...
    <script>
        ...
        function showPreview(file) {
            ...
            reader.onload = function (e) {
                ...
                fotoStatus.innerHTML   = '<i class="fas fa-check-circle"></i> Foto berhasil diunggah';
